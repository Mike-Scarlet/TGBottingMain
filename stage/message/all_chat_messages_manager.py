...
class AllChatMessageManager:
  ...
  async def _GeneralInsertMessage(self, chat_manager: SingleChatMessageManager, message: pyrogram.types.Message, message_source: "ChatMessageSource", force_update_db=False):
